...
const Navbar = () => {
	...
	return (
		<nav className="bg-black h-20 p-4 ">
			<div className="container mx-auto">
				<div className="flex justify-between items-center">
					<div className="text-white font-bold text-xl cursor-pointer hover:text-green-500" onClick={() => { navigate('/') }}>Turf's Corner </div>
					<div className="block lg:hidden">
					</div>
					<div className="lg:flex items-center justify-between text-lg gap-8">
						{isLogin && <>
							<p className="text-white font-medium cursor-pointer hidden lg:block hover:text-green-500" onClick={() => { navigate('/') }}>Home</p>
							<p className="text-white font-medium cursor-pointer hidden lg:block hover:text-green-500" onClick={() => { navigate('/grounds') }}>Grounds</p>
							<p className="text-white font-medium cursor-pointer hidden lg:block hover:text-green-500" onClick={() => { navigate('/grounds') }}>Contact me</p>
						</>}
					...
					{!isLogin &&
						...
						{!isLogin &&
							<button className="bg-white text-black font-bold px-4 py-2 rounded-md hover:text-green-500" onClick={handleLogin}>Login</button>
						}
						{isLogin &&
